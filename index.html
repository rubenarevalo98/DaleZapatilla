...
<body style="margin-bottom: 32px;">
	...
	<section>
		<div class="sectionBox">
			...
			<h2 class="sectionTitle">Somos aficionados, y ¡queremos correr! Así que aquí estamos, organizándolo todo:).
				<br><br>
			...
			<ul id="newsList">
				...
				<li>
					...
					<div>
						...
						<span class="newsPreview">
							¡Contáctanos! Somos aficionados como tú, y todos en algún momento nos hemos sentido perdidos
				...
				<ul id="newsList">
					...
					<li>
						...
						<div>
							...
							<span class="newsPreview">
								Solo buscamos hacer algo en que todos podamos pasarlo bien. Todo buen rollo, con coches para todos los gustos, colores y bolsillos. Y ganes o quedes último, además de la experiencia, ¡te llevarás una medalla para recordarlo!
							</span>
							<br>
							<br>
		...
		<div id="cookie-bar-prompt" style="display:none">
			<div id="cookie-bar-prompt-content">
				...
				<p>Esta web utiliza cookies para mejorar la experiencia y proporcionar funcionalidades adicionales.
					Ninguna de esta información puede ser o será utilizada para identificarle o contactarle.<br>

					<i id="cookie-bar-thirdparty" style="display: block;">
						<br>Esta web utiliza cookies de terceros, consulte los detalles en la política de
						privacidad.<br>
					</i>

					<i id="cookie-bar-tracking" style="display: block;">
						<br>Esta web utiliza cookies de seguimiento, consulte los detalles en la política de
						privacidad.<br>
					</i>

					<i id="cookie-bar-privacy-page" style="display: inline-block;">
						<br>Para saber más sobre cómo se utilizan las cookies en esta web consulte nuestra <a rel="nofollow" id="cookie-bar-privacy-link" href="https://www.timeattackseries.com/cookie-policy.html">POLÍTICA DE
							PRIVACIDAD</a>.<br><br></i>

					<br>Pulsando <span>Aceptar cookies</span>, <span id="cookie-bar-scrolling">o desplazándose a través
						de la página,</span> está dando su consentimiento a que se almacenen pequeñas cantidades de
					información en su navegador.
					<i id="cookie-bar-no-consent" style="display: none;">
						<br>
						<br>Pulsando <span>No aceptar cookies</span> rechaza que se almacene información alguna para
						esta web y posiblemente se borre las cookies ya existente (algunas partes de la web podrían
